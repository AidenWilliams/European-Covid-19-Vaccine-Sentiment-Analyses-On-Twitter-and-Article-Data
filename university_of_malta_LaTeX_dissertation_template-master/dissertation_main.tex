...
\doctype{Individual Assigned Practical Task}               % the type of document (fyp, dissertation, thesis)
...
\graphicspath{{./images/}{./chap1/images/}{./chap2/images/}{./chap3/images/}{./chap4/images/}{./appA/}}     % Paths where to look for images, if defined "images" must always be there as it holds the images in-use by the template.
